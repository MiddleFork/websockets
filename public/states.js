...
var states = function() {
    ...
    // polygon data for the 50 states
    var statesJSON = {states: [
        {state: "Alaska",
         coordinates: [
    ...
    return {
        ...
        getStatePolygon : function(stateName) {
            return statePolys[stateName];
        },
        ...
        inUSA : function(lat, lng) {
            return (typeof this.getState(lat,lng) != "undefined");
        },
