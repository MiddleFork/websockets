...
var deviceMap = function() {
    ...
    var numDeltas          = 240 - 4; // 1 delta every 1/4 second for 60 seconds (60 * 4) minus 1 second
    ...
    function transition(marker, markerId, latitude, longitude, callbackFn){
        ...
        if (typeof markerTransitions[markerId] != "undefined") {
            ...
            console.log("Rapidly completed existing transition");
        }
    ...
    function moveMarker(marker, markerId){
        if (typeof markerTransitions[markerId] != "undefined") {
            ...
            if ( markerTransitions[markerId].deltaNum != numDeltas ){
                ...
                markerTransitions[markerId].timeout = setTimeout(function() {moveMarker(marker, markerId);}, delay);
            } else {
